		...
		<div class="main">
			...
			<div class="article">
                ...
                <form action="updateusername.php" method="post">
                    ...
                    <input type = "text" name = "ConUser" class = "input" placeholder="Confirm Username here..."><br>
                    <p>New Username:</p>
                    <input type = "text" name = "NewUser" class = "input" placeholder="New Username here..."><br>
                ...
                <?php
					...
					if(strpos($url, "update=invaliduser") == true){ 
						echo "<p>Please enter valid username</p>";
					}
					if(strpos($url, "error=queryfailed") == true){ 
						echo "<p>An error occured</p>";
					}
					if(strpos($url, "update=usernamedoesntmatch") == true){ 
